...
import { ApiResponse } from '../../HOA/services/residents.service';
import Swal from 'sweetalert2';
import { catchError } from 'rxjs/operators';
import { ResidentsService } from '../../HOA/services/residents.service';
import { MaintenanceService, MaintenanceRequest } from './maintenance.service';

@Component({
  selector: 'app-maintenancereq',
  standalone: true,
  imports: [
    SidenavComponent,
    NavbarComponent,
  ...
  templateUrl: './maintenancereq.component.html',
  styleUrls: ['./maintenancereq.component.css']
})
export class MaintenancereqComponent implements OnInit {
  isNavOpen = true;
